...
1. Craft a set of course outcomes/objectives for the SC2XX (*Introduction to Scientific Computing*) course
...
4. Write up a short "Informational Sheet" about our proposal that can be shared more broadly with the University Community

. . .

**Summer 2024 Progress:** We are proud to report that we've completed items 1, 2, and parts of 3 and 4
...
+ **(Document Analyses)** Clearly and concisely document a problem and solution within a notebook environment
+ **(Full Reproducibility)** Mix scientific computing (numerical methods) together with text explanations in a single notebook environment, producing truly transparent and reproducible analyses
+ **(Version Control)** Utilize GitHub for version-control and for collaboration
+ **(Numerical Techniques)** Possess a command of several numerical methods and simulation techniques that they can apply to problems in their home disciplines
+ **(Portfolio)** Have created a professional GitHub pages portfolio that they can utilize and add to for the remainder of their time at SNHU and beyond
...
1. Finalize a draft syllabus for SC2XX (Introduction to Scientific Computing)
2. Finalize our current draft "Informational Sheet" so that we can begin sharing it with potential partner disciplines and faculty

. . .

We have the following additional goals:

1. Begin discussions with faculty from other disciplines about whether their students could benefit from this course experience
2. Help those faculty identify candidate courses within their degree program that could serve as a suitable *second-tier* course in a certificate in *Scientific Computing*
3. Prepare for the SC2XX course to go through the academic governance pipeline
