...
4. Write up a short "Informational Sheel" about our proposal that can be shared more broadly with the University Community

## Summer 2024 Progress

. . . 

We are proud to report that we've completed items 1, 2, and parts of 3 and 4 from the previous slide.
...
+ Mix scientific computing (numerical methods) together with text explanations in a single notebook environment, producing truly transparent and reproducible analyses
+ Utilize GitHub for version-control and for collaboration
+ Possess a command of several numerical methods and simulation techniques that they can apply to problems in their home disciplines
