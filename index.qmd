...
1. **(Tier 1)** Development of a 200-level course on an Introduction to Scientific Computing
2. **(Tier 2)** Identification and collaboration with faculty partners in other disciplines to find discipline-specific courses that utilize computational methods
3. **(Tier 3a)** Development of a culminating scientific computing experience in which students earn credit for applying computing techniques to solve a problem of interest for a partner
4. **(Tier 3b)** Package items 1 - 3 into a three-course certificate in Scientific Computing which can be earned by SNHU students

### Tier 1: SC2XX Introduction to Scientific Computing
